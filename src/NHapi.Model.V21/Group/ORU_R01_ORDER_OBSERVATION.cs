namespace NHapi.Model.V21.Group
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ORU_R01_ORDER_OBSERVATION"/> class.
        /// </summary>
            ...
            : base(parent, factory)
        {
            try
            {
                ...
                add(typeof(ORU_R01_OBSERVATION), true, true);
            }
        ...
        /// <summary>
        /// Gets the number of existing repetitions of ORU_R01_OBSERVATION.
        /// </summary>
        ...
        /// <summary>
        /// Gets the ORU_R01_OBSERVATION results.
        /// </summary>
        public IEnumerable<ORU_R01_OBSERVATION> OBSERVATIONs
        {
            get
            {
                ...
                {
                    yield return (ORU_R01_OBSERVATION)GetStructure("OBSERVATION", rep);
                }
            }
        }
        ...
        /// </summary>
        /// <returns>An ORU_R01_OBSERVATION group object.</returns>
        public ORU_R01_OBSERVATION GetOBSERVATION()
        {
            try
            {
                return (ORU_R01_OBSERVATION)GetStructure("OBSERVATION");
            }
            catch (HL7Exception e)
            {
                HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
        ...
        /// <summary>
        /// Returns a specific repetition of ORU_R01_OBSERVATION * (a Group object) - creates it if necessary.
        /// </summary>
        /// <param name="rep">The number of repetitions.</param>
        /// <returns>An ORU_R01_OBSERVATION group object.</returns>
        /// <exception cref="HL7Exception">Thrown if the repetition requested is more than one greater than the number of existing repetitions.</exception>
        ...
        {
            return (ORU_R01_OBSERVATION)GetStructure("OBSERVATION", rep);
        }
        ...
        {
            return AddStructure("OBSERVATION") as ORU_R01_OBSERVATION;
        }
