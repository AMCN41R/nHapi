namespace NHapi.Model.V21.Group
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ORU_R03_PATIENT_RESULT"/> class.
        /// </summary>
        /// <param name="parent">The parent group.</param>
        /// <param name="factory">The model class factory.</param>
        public ORU_R03_PATIENT_RESULT(IGroup parent, IModelClassFactory factory)
            : base(parent, factory)
        {
            try
            {
                add(typeof(ORU_R03_PATIENT), false, false);
                add(typeof(ORU_R03_ORDER_OBSERVATION), true, true);
            }
        ...
        /// <summary>
        /// Gets the ORU_R03_PATIENT (a Group object) - creates it if necessary.
        /// </summary>
        public ORU_R03_PATIENT PATIENT
        {
            get
            {
                try
                {
                    return (ORU_R03_PATIENT)GetStructure("PATIENT");
                }
                catch (HL7Exception e)
                {
        ...
        /// <summary>
        /// Gets the number of existing repetitions of ORU_R03_ORDER_OBSERVATION.
        /// </summary>
        ...
        /// <summary>
        /// Gets the ORU_R03_ORDER_OBSERVATION results.
        /// </summary>
        public IEnumerable<ORU_R03_ORDER_OBSERVATION> ORDER_OBSERVATIONs
        {
            get
            {
                ...
                {
                    yield return (ORU_R03_ORDER_OBSERVATION)GetStructure("ORDER_OBSERVATION", rep);
                }
            }
        }

        /// <summary>
        /// Returns the first repetition of ORU_R03_ORDER_OBSERVATION (a Group object) - creates it if necessary.
        /// </summary>
        /// <returns>An ORU_R03_ORDER_OBSERVATION group object.</returns>
        public ORU_R03_ORDER_OBSERVATION GetORDER_OBSERVATION()
        {
            try
            {
                return (ORU_R03_ORDER_OBSERVATION)GetStructure("ORDER_OBSERVATION");
            }
            catch (HL7Exception e)
            {
                HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
        ...
        /// <summary>
        /// Returns a specific repetition of ORU_R03_ORDER_OBSERVATION * (a Group object) - creates it if necessary.
        /// </summary>
        ...
        {
            return (ORU_R03_ORDER_OBSERVATION)GetStructure("ORDER_OBSERVATION", rep);
        }
        ...
        {
            return AddStructure("ORDER_OBSERVATION") as ORU_R03_ORDER_OBSERVATION;
        }
