...
public class ORU_R03 : AbstractMessage  {
    ...
    /// </summary>
    public ORU_R03(IModelClassFactory factory)
        : base(factory){
       init(factory);
    }
    ...
    private void init(IModelClassFactory factory) {
       try {
          ...
          add(typeof(ORU_R03_PATIENT_RESULT), true, true);
...
get{
    ...
    public ORU_R03_PATIENT_RESULT GetPATIENT_RESULT() {
       ...
       try {
          ret = (ORU_R03_PATIENT_RESULT)GetStructure("PATIENT_RESULT");
       } catch(HL7Exception e) {
          HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
          throw new Exception("An unexpected error occurred",e);
       }
    ...
    public ORU_R03_PATIENT_RESULT GetPATIENT_RESULT(int rep) {
       return (ORU_R03_PATIENT_RESULT)GetStructure("PATIENT_RESULT", rep);
    }
...
get{
    ...
    public IEnumerable<ORU_R03_PATIENT_RESULT> PATIENT_RESULTs
    {
        get
        {
            ...
            {
                yield return (ORU_R03_PATIENT_RESULT)GetStructure("PATIENT_RESULT", rep);
            }
        }
    }
    ...
    {
        return AddStructure("PATIENT_RESULT") as ORU_R03_PATIENT_RESULT;
    }
