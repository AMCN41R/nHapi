...
get{
    ...
    public FT1 GetFT1(int rep) {
       return (FT1)GetStructure("FT1", rep);
    }
...
get{
    ...
    public IEnumerable<FT1> FT1s
    {
        get
        {
            for (var rep = 0; rep < FT1RepetitionsUsed; rep++)
            {
                yield return (FT1)GetStructure("FT1", rep);
            }
        }
    }
    ...
    public FT1 AddFT1()
    {
        return AddStructure("FT1") as FT1;
    }
