...
public class UDM_Q05 : AbstractMessage  {
    ...
    /// </summary>
    public UDM_Q05(IModelClassFactory factory)
        : base(factory){
       init(factory);
    }
    ...
    private void init(IModelClassFactory factory) {
       try {
          ...
          add(typeof(URD), true, false);
          add(typeof(URS), false, false);
          add(typeof(DSP), true, true);
...
get{
    ...
    public DSP GetDSP(int rep) {
       return (DSP)GetStructure("DSP", rep);
    }
...
get{
    ...
    public IEnumerable<DSP> DSPs
    {
        get
        {
            for (var rep = 0; rep < DSPRepetitionsUsed; rep++)
            {
                yield return (DSP)GetStructure("DSP", rep);
            }
        }
    }
    ...
    public DSP AddDSP()
    {
        return AddStructure("DSP") as DSP;
    }
