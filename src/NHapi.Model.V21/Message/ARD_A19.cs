...
public class ARD_A19 : AbstractMessage  {
    ...
    /// </summary>
    public ARD_A19(IModelClassFactory factory)
        : base(factory){
       init(factory);
    }
    ...
    private void init(IModelClassFactory factory) {
       try {
          ...
          add(typeof(ARD_A19_QUERY_RESPONSE), true, true);
...
get{
    ...
    public ARD_A19_QUERY_RESPONSE GetQUERY_RESPONSE() {
       ...
       try {
          ret = (ARD_A19_QUERY_RESPONSE)GetStructure("QUERY_RESPONSE");
       } catch(HL7Exception e) {
          HapiLogFactory.GetHapiLog(GetType()).Error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
          throw new Exception("An unexpected error occurred",e);
       }
    ...
    public ARD_A19_QUERY_RESPONSE GetQUERY_RESPONSE(int rep) {
       return (ARD_A19_QUERY_RESPONSE)GetStructure("QUERY_RESPONSE", rep);
    }
...
get{
        var reps = -1;
        try {
            reps = GetAll("QUERY_RESPONSE").Length;
        } catch (HL7Exception e) {
