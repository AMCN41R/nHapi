...
public class MRG : AbstractSegment  {
   ...
   */
    ...
    var message = Message;
    try {
       add(typeof(CK), true, 1, 16, new object[]{message}, "PRIOR PATIENT ID - INTERNAL");
       add(typeof(CK), false, 1, 16, new object[]{message}, "PRIOR ALTERNATE PATIENT ID");
       add(typeof(CK), false, 1, 20, new object[]{message}, "PRIOR PATIENT ACCOUNT NUMBER");
