...
public class QRD : AbstractSegment  {
   ...
   */
    ...
    var message = Message;
    try {
       add(typeof(TS), true, 1, 19, new object[]{message}, "QUERY DATE/TIME");
       add(typeof(ID), true, 1, 1, new object[]{message, 106}, "QUERY FORMAT CODE");
       add(typeof(ID), true, 1, 1, new object[]{message, 91}, "QUERY PRIORITY");
       add(typeof(ST), true, 1, 10, new object[]{message}, "QUERY ID");
       add(typeof(ID), false, 1, 1, new object[]{message, 107}, "DEFERRED RESPONSE TYPE");
       add(typeof(TS), false, 1, 19, new object[]{message}, "DEFERRED RESPONSE DATE/TIME");
       add(typeof(CQ), true, 1, 5, new object[]{message}, "QUANTITY LIMITED REQUEST");
       add(typeof(ST), true, 0, 20, new object[]{message}, "WHO SUBJECT FILTER");
       add(typeof(ID), true, 0, 3, new object[]{message, 48}, "WHAT SUBJECT FILTER");
       add(typeof(ST), true, 0, 20, new object[]{message}, "WHAT DEPARTMENT DATA CODE");
       add(typeof(ST), false, 0, 20, new object[]{message}, "WHAT DATA CODE VALUE QUAL.");
       add(typeof(ID), false, 1, 1, new object[]{message, 108}, "QUERY RESULTS LEVEL");
