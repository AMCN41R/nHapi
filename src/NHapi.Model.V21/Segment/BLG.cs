...
public class BLG : AbstractSegment  {
   ...
   * message.
   */
    public BLG(IGroup parent, IModelClassFactory factory)
        : base(parent,factory) {
    var message = Message;
    try {
       add(typeof(CM), false, 1, 15, new object[]{message}, "WHEN TO CHARGE");
       add(typeof(ID), false, 1, 50, new object[]{message, 122}, "CHARGE TYPE");
       add(typeof(CM), false, 1, 100, new object[]{message}, "ACCOUNT ID");
