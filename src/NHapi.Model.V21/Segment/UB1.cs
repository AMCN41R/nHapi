...
public class UB1 : AbstractSegment  {
   ...
   */
    ...
    var message = Message;
    try {
       add(typeof(SI), false, 1, 4, new object[]{message}, "SET ID - UB82");
       add(typeof(ST), false, 1, 1, new object[]{message}, "BLOOD DEDUCTIBLE");
       add(typeof(ST), false, 1, 2, new object[]{message}, "BLOOD FURN.-PINTS OF (40)");
       add(typeof(ST), false, 1, 2, new object[]{message}, "BLOOD REPLACED-PINTS (41)");
       add(typeof(ST), false, 1, 2, new object[]{message}, "BLOOD NOT RPLCD-PINTS(42)");
       add(typeof(ST), false, 1, 2, new object[]{message}, "CO-INSURANCE DAYS (25)");
       add(typeof(ID), false, 5, 2, new object[]{message, 43}, "CONDITION CODE");
       add(typeof(ST), false, 1, 3, new object[]{message}, "COVERED DAYS - (23)");
       add(typeof(ST), false, 1, 3, new object[]{message}, "NON COVERED DAYS - (24)");
       add(typeof(CM), false, 8, 12, new object[]{message}, "VALUE AMOUNT and CODE");
       add(typeof(ST), false, 1, 2, new object[]{message}, "NUMBER OF GRACE DAYS (90)");
       add(typeof(ID), false, 1, 2, new object[]{message, 0}, "SPEC. PROG. INDICATOR(44)");
       add(typeof(ID), false, 1, 1, new object[]{message, 0}, "PSRO/UR APPROVAL IND. (87)");
       add(typeof(DT), false, 1, 8, new object[]{message}, "PSRO/UR APRVD STAY-FM(88)");
       add(typeof(DT), false, 1, 8, new object[]{message}, "PSRO/UR APRVD STAY-TO(89)");
       add(typeof(ID), false, 5, 20, new object[]{message, 0}, "OCCURRENCE (28-32)");
       add(typeof(ID), false, 1, 2, new object[]{message, 0}, "OCCURRENCE SPAN (33)");
       add(typeof(DT), false, 1, 8, new object[]{message}, "OCCURRENCE SPAN START DATE(33)");
       add(typeof(DT), false, 1, 8, new object[]{message}, "OCCUR. SPAN END DATE (33)");
       add(typeof(ST), false, 1, 30, new object[]{message}, "UB-82 LOCATOR 2");
       add(typeof(ST), false, 1, 7, new object[]{message}, "UB-82 LOCATOR 9");
       add(typeof(ST), false, 1, 8, new object[]{message}, "UB-82 LOCATOR 27");
       add(typeof(ST), false, 1, 17, new object[]{message}, "UB-82 LOCATOR 45");
